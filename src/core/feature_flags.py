...
def reload_flags() -> None:
    ...
    global FEATURE_TASK_GRAPH_EXECUTION, FEATURE_NETWORK_ALLOWLIST
...
def log_feature_flags() -> None:
    ...
    logger.info(
        "Fix Pack V1 flags: RESPONSE_ASSEMBLER=%s, EXECUTION_TOKENS=%s, TASK_GRAPH=%s, NETWORK_ALLOWLIST=%s",
